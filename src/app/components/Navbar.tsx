        ...
        >
            <div className="container mx-auto px-4 sm:px-6 lg:px-12">
                <div className="flex h-16 items-center justify-between">
                    ...
                    {/* Register Button */}
                    <button className="hidden md:block rounded-md bg-yellow-400 px-5 py-2 text-sm font-medium text-black transition-all duration-300 hover:bg-yellow-500 hover:shadow-md transform hover:-translate-y-0.5 active:translate-y-0">
                        Daftar Sekarang
                    </button>
