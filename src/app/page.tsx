...
export default function Home() {
  return (
    <div>
      <section className="card mx-5 lg:mx-28 lg:h-[30rem] bg-linear-to-b from-[#128884] to-[#03B5AA] flex lg:flex-row flex-col gap-8 lg:gap-0 items-center justify-between rounded-lg text-white lg:px-16 px-8 py-8 mb-8">
        ...
        <div className="maskot-image">
          <Image src="/robot.png" alt="maskot" width={400} height={400} objectFit="contain" />
        </div>
      </section>
